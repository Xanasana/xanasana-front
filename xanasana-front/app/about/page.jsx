...
const About = () => {
    ...
    return (
        <motion.section
            className="min-h-screen flex items-center overflow-x-hidden max-w-[1920px] mx-auto"
            initial={{opacity: 0}}
            animate={{
                opacity: 1,
                transition: {
        ...
        >
            <div className="container mx-auto flex items-center pt-48 pb-4 lg:pt-32 lg:pb-0">
                <div className="w-full h-full flex flex-col lg:flex-row items-center justify-between gap-2 lg:gap-8">
                    {/* Image */}
                    <motion.div 
                        className="relative w-[300px] h-[420px] lg:w-[380px] xl:w-[450px] lg:h-[530px] xl:h-[600px] mb-8 lg:mb-0 "
                    ...
                    >
                        <Image
                            className="object-contain w-[300px] h-[420px] lg:w-[380px] xl:w-[450px] lg:h-[530px] xl:h-[600px] max-w-[450px] max-h-[600px]"
